...
setup(
  ...
  version = '7.4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sferlix/frankAllSkyCam/archive/refs/tags/7.4.tar.gz',    # I explain this later on
