...
setup(
  ...
  version = '7.5',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sferlix/frankAllSkyCam/archive/refs/tags/7.5.tar.gz',    # I explain this later on
