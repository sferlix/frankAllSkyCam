...
def getSQM():
   ...
   if sq < 9:
      ...
      myExp=[ 9.00,   9.50, 9.56,   9.70,  10.0, 10.50, 11.00, 11.5, 12.0, 12.5, 13.5, 14.0, 14.5, 15.0, 15.5, 16.5,  17]
      mySqm=[ 0.001, 0.005, 0.007, 0.009, 0.012, 0.015, 0.025, 0.02, 0.07, 0.20, 0.38, 0.60, 0.60, 0.70, 1.10,  1.8, 2.2]
      polyGrade = 3
   else:
      myExp=[17.0, 17.5, 17.7, 18.0, 18.5, 19.5, 20.5, 21, 21.8]
      mySqm=[2.2,  3.00, 6.50, 10.0, 15.0, 30.0, 45.0, 55, 60]
      polyGrade = 3
