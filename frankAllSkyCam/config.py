...
# do not add file extension .mp4, but only prefix. In facts:
# frankAllSkyCam_night.mp4 will be generated if nightTL = True (see [timelapse] section)
# frankAallSkyCam_24h.mp4 will be generated if fullTL = True (see [timelapse] section)
